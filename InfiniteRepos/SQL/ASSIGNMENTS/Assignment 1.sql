-- Create InfiniteAssignment database
CREATE DATABASE InfiniteAssignment;
GO

-- Use the InfiniteAssignment database
...
-- Select all data from the Projects table
SELECT * FROM Projects;

-- Select all data from the EmpProjectTasks table
